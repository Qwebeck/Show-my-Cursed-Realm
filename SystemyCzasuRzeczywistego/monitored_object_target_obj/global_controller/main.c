 ...
 * (global_controller_the_alarm_control_thread_k) the second is the period 
 * defined in the AADL model. Third is the task priority ( 10), fourth is 
 * the stack size ( 0 bytes) and last is the subprogram executed by the task
 */
  __po_hi_create_periodic_task (global_controller_the_alarm_control_thread_k, &(period), 10, 0, 0, the_alarm_control_thread_job);
